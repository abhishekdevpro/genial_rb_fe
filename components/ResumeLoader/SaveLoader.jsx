    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 backdrop-blur-sm">
      <div className="bg-white bg-opacity-10 p-8 rounded-lg flex flex-col items-center shadow-lg">
        <div className="w-16 h-16 mb-4 relative">
          ...
          <div className="absolute inset-0 border-4 border-[#A810C7] border-t-transparent rounded-full animate-spin"></div>

          {/* Inner pulsing circle */}
          <div className="absolute inset-2 bg-[#A810C7] rounded-full animate-pulse"></div>
        </div>
