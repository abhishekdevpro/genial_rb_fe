...
//             </p>
//             <button className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-emerald-500 transition-colors">
//               Select PDF File
//             </button>
...
//           className="px-8 py-3 bg-green-500 text-black rounded-lg font-medium hover:bg-emerald-500 transition-colors
...
//               {value ? value.name : "Drag and drop your resume here"}
//             </p>
//             <button className="px-6 py-3 bg-emerald-500 text-white rounded-lg hover:bg-emerald-500 transition-colors">
//               Select PDF File
//             </button>
//             <p className="mt-4 text-sm text-gray-500">
//               Maximum file size: 10MB
...
//           className="px-8 py-3 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-500 transition-colors
    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
      ...
      >
        ...
        {isUploading ? (
          ...
          <>
            ...
            <button className="px-6 py-3 bg-emerald-500 text-white rounded-lg hover:bg-[#008f6b]">
      ...
      <div className="flex justify-between mt-12">
        ...
        <button
          ...
          className="px-8 py-3 bg-emerald-500 text-white rounded-lg font-medium hover:bg-[#008f6b] disabled:opacity-50 disabled:cursor-not-allowed"
        >
