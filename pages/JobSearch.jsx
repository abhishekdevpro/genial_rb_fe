...
//           <button
//             onClick={fetchJobs}
//             className="w-full py-2 px-4 bg-[#A810C7] text-white rounded-lg "
//           >
//             Search Jobs
//           </button>
//         </div>
...
//               >
//                 <h3 className="text-xl font-semibold text-[#A810C7]">
//                   {job.title}
//                 </h3>
...
//                   className="text-[#A810C7] hover:underline mt-2 block"
//                 >
//                   Apply Now
//                 </a>
//               </div>
...
const JobSearch = () => {
  ...
  //         "https://api.genialcareer.fr/api/user/job-list"
  //       );
  //       if (!response.ok) {
        ...
        {!loading && !error && jobResults.length > 0 && (
          <div className="mt-8 grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {jobResults.map((job) => (
              ...
              >
                <h3
                  className="text-xl font-semibold text-[#A810C7] cursor-pointer"
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
            ...
            <div className="flex justify-end">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#A810C7] text-white py-2 px-4 rounded-lg mr-2"
              >
                {t("jobsearch.apply_now")}
              </a>
              <button
