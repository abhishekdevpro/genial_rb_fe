...
// //         <button className="px-16 py-2 bg-yellow-400 text-lg rounded-3xl hover:bg-[#A810C7]" onClick={handleNext}>Next</button>
// //       </div>
// //     </div>
// //   );
// // };
...
//         <button className="px-16 py-2 bg-yellow-400 text-lg rounded-3xl hover:bg-[#A810C7] float-end" onClick={handleNext}>Next</button>
//       </div>
