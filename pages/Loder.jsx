...
// //         <button className="px-16 py-2 bg-yellow-400 text-lg rounded-3xl hover:bg-emerald-500" onClick={handleNext}>Next</button>
// //       </div>
// //     </div>
// //   );
// // };
...
//         <button className="px-16 py-2 bg-yellow-400 text-lg rounded-3xl hover:bg-emerald-500 float-end" onClick={handleNext}>Next</button>
//       </div>
