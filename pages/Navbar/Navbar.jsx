...
//                 <Link
//                   href="/dashboard"
//                   className="text-black hover:text-[#A810C7] px-3 py-2 rounded-md text-lg font-semibold"
//                 >
//                   Dashboard
//                 </Link>
//                 <Link
...
//                   className="flex items-center bg-[#A810C7] text-white px-4 py-2 text-md font-semibold border-2 rounded-xl"
//                 >
//                   {/* <img
...
//                 <Link
//                   href="/login2"
//                   className="bg-[#A810C7] text-white  px-4 py-2 text-md font-semibold border-2 rounded-xl"
//                 >
//                   Log in
//                 </Link>
//                 {/* <Link
...
//               className="text-black hover:text-[#A810C7] focus:outline-none px-3 py-2 rounded-md text-sm font-medium"
//             >
//               <svg
//                 className="w-6 h-6"
//                 fill="none"
...
//               <Link
//                 href="/dashboard"
//                 className="text-black hover:text-[#A810C7] block  px-3 py-2 rounded-md text-base font-semibold"
//               >
//                 Dashboard
//               </Link>
//               <Link
...
//                 <Link
//                   href="/"
//                   className="bg-[#A810C7] text-white  block px-3 py-2 rounded-md text-base font-semibold"
//                   onClick={() => {
//                     handleLogout();
//                     handleLinkClick();
//                   }}
