...
//                 <Link
//                   href="/dashboard"
//                   className="text-black hover:text-emerald-500 px-3 py-2 rounded-md text-lg font-semibold"
//                 >
//                   Dashboard
//                 </Link>
//                 <Link
...
//             </Link>
//             <Link
//               href="https://blog.genialcareer.fr/"
//               className="text-black hover:text-emerald-500 px-3 py-2 rounded-md text-lg font-semibold"
//             >
//               Resources
//             </Link>
...
//                   className="flex items-center bg-emerald-500 text-white px-4 py-2 text-md font-semibold border-2 rounded-xl"
//                 >
//                   {/* <img
...
//                     src={
//                       photo
//                         ? `https://api.genialcareer.fr${photo}`
...
//                 <Link
//                   href="/login2"
//                   className="bg-emerald-500 text-white  px-4 py-2 text-md font-semibold border-2 rounded-xl"
//                 >
//                   Log in
//                 </Link>
//                 {/* <Link
...
//               className="text-black hover:text-emerald-500 focus:outline-none px-3 py-2 rounded-md text-sm font-medium"
//             >
//               <svg
//                 className="w-6 h-6"
//                 fill="none"
...
//               <Link
//                 href="/dashboard"
//                 className="text-black hover:text-emerald-500 block  px-3 py-2 rounded-md text-base font-semibold"
//               >
//                 Dashboard
//               </Link>
//               <Link
...
//                 <Link
//                   href="/"
//                   className="bg-emerald-500 text-white  block px-3 py-2 rounded-md text-base font-semibold"
//                   onClick={() => {
//                     handleLogout();
//                     handleLinkClick();
//                   }}
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-zinc-300 border-b border-zinc-300 ">
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0 flex items-center">
            <Link href="/">
              <Image src={logo} alt="logo" className="h-100  w-[160px] mb-2" />
            </Link>
          </div>
          <div className="hidden md:flex justify-center items-center space-x-4">
            {isLoggedIn ? (
