...
const MyCvLetter = () => {
  ...
  return (
    ...
    //       className="flex items-center px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-emerald-500 transition-colors duration-200 font-medium shadow-sm"
    //     >
    ...
    //                       className="text-emerald-500 hover:text-blue-800"
    //                     >
    //                       🖍
    //                     </button>
    //                   </div>
    ...
    //                       className="text-emerald-500 hover:text-emerald-500 transition-colors duration-200"
    //                     >
    ...
    //             className="px-4 py-2 text-sm font-medium text-white bg-emerald-500 rounded-md hover:bg-emerald-500"
    //           >
    //             Save
    //           </button>
    //         </div>
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
        ...
        <button
          onClick={handleCreate}
          className="flex items-center px-4 py-2 bg-emerald-500 text-white rounded-lg hover:bg-[#5a23b2] transition-colors duration-200 font-medium shadow-sm"
        >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm mx-4">
            ...
            <div className="flex justify-end space-x-3 mt-4">
              ...
              <button
                onClick={handleUpdateCvLetterTitle}
                className="px-4 py-2 text-sm font-medium text-white bg-emerald-500 rounded-md hover:bg-[#5a23b2]"
              >
                {t("mycvletter.save")}
              </button>
            </div>
