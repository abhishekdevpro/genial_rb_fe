...
//           Careers at Genial Career
//         </h2>
//         <h2 className="text-xl sm:text-2xl font-semibold my-2 mt-5">
//           Join Our Team
//         </h2>
//         <p className="text-base sm:text-lg">
//           At Genial Career, we are committed to helping individuals achieve their
...
//         </h3>
//         <p className="text-base sm:text-lg">
//           At Genial Career, we believe in the power of collaboration. Our team
...
//         </h3>
//         <p className="text-base sm:text-lg">
//           Your work at Genial Career will have a direct impact on our clients’
...
//           client has a positive experience with Genial Career.
//         </p>
...
//         </h3>
//         <p className="text-base sm:text-lg">
//           At Genial Career, you’ll have the opportunity to make a meaningful impact
    ...
    <div>
      ...
      <div className="m-4 sm:mx-10 lg:mx-40 p-4 sm:p-6 shadow-2xl">
        ...
        <p className="text-base sm:text-lg">
          ...
          <a href="mailto:career@genialcareer.com" className="text-purple-500">
            {t("apply_email")}
          </a>
          .
        </p>
