...
//           Welcome to Genial Career. These terms and conditions outline the rules and
//           regulations for the use of Genial Careers website and services. By
...
//           <li>
//             Client: Any individual or entity using the services of Genial Career.
//           </li>
//           <li>Company: Genial Career.</li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             All content, materials, and services provided by Genial Career are
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             Genial Career respects the privacy and confidentiality of its clients.
//           </li>
//           <li>
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             Genial Career will not be liable for any direct, indirect, incidental,
...
//         <ul className="list-inside list-disc pl-4 text-base sm:text-lg">
//           <li>
//             Genial Career reserves the right to modify or update these terms and
...
//             accordance with the laws of the jurisdiction in which Genial Career
//             operates.
//           </li>
//           <li>
