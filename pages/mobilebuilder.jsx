...
export default function MobileBuilder() {
    ...
    <div className="fixed px-2 bottom-0 left-0 right-0 bg-white shadow-lg py-4 ">
      <div className="flex justify-between items-center">
        <button
          ...
          className="px-4 py-2 bg-[#5a23b2] text-white rounded-lg disabled:opacity-50"
        >
          {t("buttons.previous")}
        </button>
  ...
  return (
    <>
      <Meta
        title="Genial Career  - AI Resume Builder"
          ...
          <div className=" bg-gray-50 flex flex-col">
            <div className="flex flex-col md:flex-row flex-grow ">
              <button
                ...
                className="fixed z-10 bottom-20 right-4  bg-[#5a23b2] text-white p-3 rounded-full shadow-lg"
              >
                {isMobileSidebarOpen ? (
            ...
            <div className="">
              <div className="flex items-center absolute justify-center gap-2 p-2  top-26 left-0 right-0 bg-white shadow-lg ">
                ...
                {/* <select
                  ...
                  className="rounded-lg border-2 border-[#5a23b2] px-5 py-2 font-bold  bg-white text-black"
                >
              ...
              <div className="flex items-center justify-center gap-4 p-2 fixed bottom-0 left-0 right-0 bg-white shadow-lg ">
                ...
                <button
                  ...
                  className="bg-[#5a23b2] text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition-colors bottom-btns"
                >
